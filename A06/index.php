    ...
    <div class="container mt-5" style="font-family: Inter;">
        <div class="row">
            ...
            <div class="col">
                ...
                <a class="btn btn-danger" href="deletion.php" role="button">Delete Account</a>
                </div>
            </div>
        </div>
        ...
        <div id="results" class="results-header mt-4"
            ...
            <h5 style="font-size:15px;"> The shown pending requests are either requests you've sent or requests you've
                received from others.</h5>
